...
SECRET_KEY = "django-insecure--n2%!$#khay*j&ppuhkkujtv#k4g-dnrd!z+s&15vbwf1%nsu!"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# These are just for docker testing, not real IPs
ALLOWED_HOSTS = [ '.orb.local', '127.0.0.1', 'localhost' ]
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'bookEx/templates')],   #added
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
